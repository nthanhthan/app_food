                  ...
                  child: MediaQuery.removePadding(
                      ...
                      child:
                        ...
                        return cartController.getItems.isEmpty
                            ? Container()
                            : ListView.builder(
                                itemCount: cartController.getItems.isEmpty
                                    ? 1
                                    : cartController.getItems.length,
                                itemBuilder: (_, index) {
                                  Get.find<CartController>().getTotalMoneyItems(
                                      cartController.getItems[index].foodId);
                                  return Container(
